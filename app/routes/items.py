...
async def get_all_items(
    ...
    results: dict = {"items": [Item(id="a", name="Spam", price=1.0)], "required_q": required_q}
...
@router.get("/{id}")
async def get_item(id: str, include_attributes: Annotated[Union[List[str], None], Query(max_length=3)] = None):
    result: dict = {
